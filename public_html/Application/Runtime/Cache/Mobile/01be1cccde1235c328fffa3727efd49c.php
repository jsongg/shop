            ...
            <div class="my-form">
                <form class="form-horizontal" action="<?php echo U('Index/reg');?>" method="post">
                    <div class="form-group">
                        <div class="col-xs-12">
                            <input type="phone" class="form-control" placeholder="请输入手机号" name="phone" id="myphone">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-xs-8">
                            <input type="password" class="form-control" id="inputPassword3" placeholder="请输入验证码" name="yzm">
                        </div>
                        <div class="col-xs-4">
                            <button class="btn bg-blue" style="color: #ffffff" id="sendsms">发送验证码</button>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-xs-12">
                    ...
                    <div class="form-group">
                        <div class="col-xs-12 text-right">
                            <button class="btn btn-lg bg-blue col-xs-12" style="color: #ffffff" id="myreg">确认</button>
                        </div>
                    </div>
                </form>
            </div>
