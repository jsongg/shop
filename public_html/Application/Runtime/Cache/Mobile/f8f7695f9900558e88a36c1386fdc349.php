            ...
            <div>
                <div class="text-center">
                    <div>
                        ...
                        <h3 style="display: inline-block;vertical-align: middle" class="media-heading"><strong>您已成功支付20元!</strong></h3>
                    </div>
                    <div class="text-center" style="margin-top: 20px">
                        <div style="display: inline-block;">  <span><strong>·</strong> 您已支付成功！ 现在您可以: </span><a class="text-primary" href="<?php echo U('Mobile/Info/detail');?>">立即查看藏品信息</a></div>
