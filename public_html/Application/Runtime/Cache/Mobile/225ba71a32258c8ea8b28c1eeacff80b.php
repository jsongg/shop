...
<div class="container">
    <div class="row">
        <div class="col-xs-12">
            ...
            <div class="my-form">
                <form class="form-horizontal" action="<?php echo U('Member/editPwd');?>" method="post">
                    <div class="form-group">
                        <div class="col-xs-12">
                            <input type="text" class="form-control" id="inputEmail3" placeholder="请输入当前登录密码" name="pwd">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-xs-12">
                            <input type="password" class="form-control" id="inputPassword3" placeholder="请输入新密码" name="pwd1">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-xs-12">
                            <input type="password" class="form-control" id="Password3" placeholder="请确认新密码" name="pwd2">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-xs-12 text-right">
                            <input type="submit" value="确定" class="btn btn-lg bg-blue col-xs-12" style="color: #ffffff">
                        </div>
                    </div>
                </form>
            </div>
