            ...
            <div class="row help">
                <div class="col-sm-10 text-center">
                    <dl class="bg-grey aside-nav">
                        ...
                        <dd class="checked"><a href="<?php echo U('Account/Record');?>">充值记录</a></dd>
            ...
            <div class="my-table">
                <table class="table">
                    ...
                    <tr class="bg-grey">
                        ...
                        <th class="text-center">充值套餐</th>
                        <th class="text-center">充值金额</th>
                        <th class="text-center">赠送代金券</th>
                        <th class="text-center">充值后总金额</th>
                        <th class="text-center">充值后总代金券</th>
                    ...
                    <?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
                        ...
                        <td class="text-center">
                            <span>套餐(<?php echo ($v["taocan"]); ?>)</span>
                        </td>
                        <td class="text-center">
                            <span><?php echo ($v["amount"]); ?></span>
                        </td>
                        <td  class="text-center">
                            <span><?php echo C('VOUCHER'.$v['taocan']);?></span>
                        </td>
                        <td class="text-center">
                            <span><?php echo ($v["balance"]); ?></span>
                        </td>
                        <td class="text-center">
                            <span><?php echo ($v["voucher"]); ?></span>
                        </td>
                        <td class="text-center">
                            <span><a href="<?php echo U('Account/recordDel');?>?id=<?php echo ($v["id"]); ?>" onclick="javascript:if(!confirm('确定删除')) return false;">删除</a></span>
                        </td>
