...
<div class="container my-container">
    <div class="row h">
        ...
        <div class="col-sm-9 col-md-10">
            ...
            <div class="row">
                <div class="col-sm-8">
                    <div class="text-center pay-success">
                        <img src="/Application/Public/images/dui.jpg" alt=""/><span>恭喜您充值成功</span>
                    </div>
                    <div class="text-center">
                        尊敬的用户，您已成功完成充值，请点击<a style="color: #2A459B" href="<?php echo U('Account/balance');?>">查看余额</a>！
                    </div>
                </div>
