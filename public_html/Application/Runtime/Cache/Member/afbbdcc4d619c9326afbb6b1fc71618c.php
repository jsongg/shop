...
<div class="container my-container">
    <div class="row h">
            ...
            <div class="row help">
                <div class="col-sm-10 text-center">
                    <dl class="bg-grey aside-nav">
                        ...
                        <dd class="checked"><a href="<?php echo U('Index/editPwd');?>">修改密码</a></dd>
        ...
        <div class="col-sm-9 col-md-10">
            ...
            <div class="my-form">
                <form class="form-horizontal" action="<?php echo U('Index/editPwd');?>" method="post">
                    <div class="form-group">
                        <label for="inputEmail3" class="col-md-2 col-sm-3 control-label">当前登录密码：</label>

                        <div class="col-md-4 col-sm-6">
                            <input type="text" class="form-control" id="inputEmail3" placeholder="原密码" name="pwd">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="inputPassword3" class="col-md-2 col-sm-3 control-label">新密码：</label>

                        <div class="col-md-4 col-sm-6">
                            <input type="password" class="form-control" id="inputPassword3" placeholder="新密码" name="pwd1">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="Password3" class="col-md-2 col-sm-3 control-label">确认新密码：</label>

                        <div class="col-md-4 col-sm-6">
                            <input type="password" class="form-control" id="Password3" placeholder="确认密码" name="pwd2">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-md-offset-2 col-md-10 col-sm-9 col-sm-offset-3">
                            <button type="submit" class="btn bg-blue col-sm-2" style="color: #ffffff">确认</button>
                        </div>
                    </div>
                </form>
            </div>
