...
<div class="container my-container">
    <div class="row h">
            ...
            <div class="row help">
                <div class="col-sm-10 text-center">
                    <dl class="bg-grey aside-nav">
                        ...
                        <dd class="checked"><a href="<?php echo U('Index/loginOut');?>">安全退出</a></dd>
                    </dl>
                </div>
            </div>
        </div>
        <div class="col-sm-9 col-md-10">
            ...
            <div class="out">
                <div>*网络账号安全，您可以安全退出登录</div>
                <a href="<?php echo U('Index/loginOutTrue');?>" class="btn btn-success" onclick="javascript:if(!confirm('确认推出')) return false;">安全退出</a>
            </div>
        </div>
    </div>
</div>
