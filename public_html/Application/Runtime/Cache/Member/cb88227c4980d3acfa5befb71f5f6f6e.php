            ...
            <div class="row help">
                <div class="col-sm-10 text-center">
                    <dl class="bg-grey aside-nav">
                        ...
                        <dd class="checked"><a href="<?php echo U('Account/balance');?>">账户余额</a></dd>
        ...
        <div class="col-sm-9 col-md-10">
            ...
            <div class="yu-e">
                <ul class="list-unstyled">
                    <li>账户：<?php echo $phone;?></li>
                    <li>余额：<span><?php echo $balance;?></span>元</li>
                    <li>代金券：<span><?php echo $voucher;?></span>元</li>
                </ul>
            </div>
        </div>
