...
<div class="container my-container">
    <ol class="breadcrumb">
        ...
        <li><a href="<?php echo U('Home/Remote/search');?>">搜索结果</a></li>
        <li>查看图片确认支付</li>
    </ol>
    <div class="panel panel-default">
        <div class="panel-heading" style="font-size: 20px;color: #264198">查看图片确认支付</div>
        <div class="panel-body">
            ...
            <div class="row">
                ...
                <form action="<?php echo U('Home/Info/pay');?>" method="post">
                    <div class="my-panel">
