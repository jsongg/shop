...
<div class="container my-container">
    <ol class="breadcrumb">
        <li><a href="#">网站首页</a></li>
        <li>图片<?php if($flag == 20): ?>识别<?php else: ?>评估<?php endif; ?>结果</li>
    </ol>
    <div class="panel panel-default">
        <div class="panel-heading" style="font-size: 20px;color: #264198"><?php if($flag == 20): ?>识别<?php else: ?>评估<?php endif; ?>图片识别结果</div>
            ...
            <div>
                <table class="table-bordered table my-table table-condensed">
                    ...
                    <tr class="text-center">
                        ...
                        <th class="text-center col-sm-10 bg-grey col-xs-7"><h5><?php if($flag == 20): ?>识别<?php else: ?>评估<?php endif; ?>图信息</h5></th>
                    </tr>
                    </thead>
                    <tbody>
                    <tr>
                        <td class="row">
                            ...
                            <div class="col-sm-12" style="margin-top: 20px">
                                <img src="<?php echo ($pic); ?>" alt="" class="img-responsive img-thumbnail"
                                     style="width: 100%"/>
                            </div>
                        ...
                        <td class="row shibie-list">
                            ...
                            <?php if(is_array($data)): foreach($data as $key=>$v): ?><div class="col-sm-4 col-xs-12">
                                    <div class="row">
                                        <div class="col-sm-10 col-sm-offset-1 col-xs-12">
                                            <div class="shibie-img"><a href=""><img src="<?php echo ($v["url"]); ?>" alt=""
                                                                 class="img-responsive img-thumbnail"
                                                                 style="width: 100%"/></a></div>
                                            <div>
                                                <ul class="list-unstyled a-list">
                                                    <li>
                                                        <b>文物名称：</b><span><?php echo ($v["name"]); ?></span>
                                                    </li>
                                                    <li>
                                            ...
                                            <div class="text-center my-btn">
                                                <?php if(empty($v['name'])==true): else: ?>
                                                    <a class="btn btn-default" href="<?php echo U('Home/Remote/detail');?>/id/<?php echo ($v["id"]); ?>/type/<?php echo ($v["name"]); ?>">查看详情</a><?php endif; ?>
                                            </div>
                                        </div>
                                    </div>
