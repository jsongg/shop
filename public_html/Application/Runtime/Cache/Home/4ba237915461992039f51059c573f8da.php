...
<head>
    ...
    <link href="/Application/Public//Application/Public//Application/Public/images/glyphicons-halflings-regular.svg" rel="stylesheet">
...
<div class="container my-container">
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body" style="padding-top: 40px;">
           ...
           <?php if(is_array($data)): foreach($data as $key=>$v): ?><div class="col-sm-4 text-center">
                   <a href="<?php echo U('Home/Info/detail');?>/id/<?php echo ($v["id"]); ?>/type/<?php echo ($v["type"]); ?>"><img src="<?php echo ($v["url"]); ?>" class="img-responsive img-thumbnail" alt="" style="max-height: 190px" /></a>
